			...
			('4','7','45','15','24','INACTIVA','65.75','7'),
			('4','7','65','25','30','ACTIVA','40','5'),
			('5','9','65','30','32','ACTIVA','44.50','9'),
			('5','9','45','25','30','INACTIVA','35','5'),
			...
			INSERT INTO died_db.boleto (NRO_BOLETO, EMAIL_CLIENTE, NOMBRE_CLIENTE, FECHA_VENTA, ID_ORIGEN, ID_DESTINO, CAMINO, COSTO)
			VALUES ('0001', 'cliente_uno@gmail.com', 'Cliente Uno','2021-02-26','7','9','caminoDATAsql','105.75'),
			('0002', 'cliente_dos@gmail.com', 'Cliente Dos','2021-03-15','1','5','caminoDATAsql','115');			
