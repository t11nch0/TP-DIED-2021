...
public class BotonEditarEstacion {
    ...
    private BotonEditarEstacion(Integer index) {
        ...
        cons0.insets = new Insets(55, 15, 20, 0);
        ...
        panelBotonEditarEstacion.add(labelNombre, cons1);
        ...
        campoNombre.setText(est.getNombreEstacion());
        panelBotonEditarEstacion.add(campoNombre, cons2);
        ...
        panelBotonEditarEstacion.add(labelHApertura, cons3);
        ...
        int horaA = est.getHorarioApertura().getHour();
        campoAHora.setSelectedIndex(horaA);
        panelBotonEditarEstacion.add(campoAHora, cons4);
        ...
        panelBotonEditarEstacion.add(labelDosPuntos1, cons5);
        ...
        int minutoA = est.getHorarioApertura().getMinute();
        campoAMinutos.setSelectedIndex(minutoA / 5);
        panelBotonEditarEstacion.add(campoAMinutos, cons6);
        ...
        int horaC = est.getHorarioCierre().getHour();
        campoCHora.setSelectedIndex(horaC);
        panelBotonEditarEstacion.add(campoCHora, cons8);
        ...
        panelBotonEditarEstacion.add(labelDosPuntos2, cons9);
        ...
        int minutoC = est.getHorarioCierre().getMinute();
        campoCMinutos.setSelectedIndex(minutoC / 5);
        panelBotonEditarEstacion.add(campoCMinutos, cons10);
        ...
        if ((est.getEstado() == EstadoEstacion.OPERATIVA)) {
        ...
        botonAtras.addActionListener(e -> {
            InterfazFrame.setPanel(EditarEstacion.getInstance().getPanelEditarEstacion());
            singleton = null;
        });
